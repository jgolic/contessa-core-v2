...
Contessa Operations is prepared for deployment as a normal online Next.js application.
...
In production without backend credentials, the app also defaults to a safer public-demo posture: view-only access, masked crew identifiers, and portrait generation disabled.
...
6. If you intentionally want live demo editing or visible crew identifiers in production, set the matching `NEXT_PUBLIC_ALLOW_*` flags explicitly before deployment.
