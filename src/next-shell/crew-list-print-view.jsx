...
function PrintActions({ vesselId }) {
  return (
    <div className="no-print">
      <div className="crew-print-actions">
      ...
      <p className="crew-print-settings-note">
        Print settings: disable Headers and Footers, paper size A4, scale 100%.
      </p>
    </div>
  );
}
      ...
      <div className="crew-print-preview">
        <main className="crew-print-page crew-a4-page">
          <div className="crew-print-content">
            ...
            {privacyNote ? <p className="mb-4 text-xs font-medium text-slate-500">{privacyNote}</p> : null}
                ...
                {crew.map((person) => {
                  ...
                  return (
                    <tr key={person.id || fullName}>
                      ...
                      <td>{getCrewIdentifierDisplay(person.passportNumber, "—", { exposeSensitiveData: exposeSensitiveCrewData })}</td>
                      <td>{getCrewIdentifierDisplay(person.seamansBookNumber, "—", { exposeSensitiveData: exposeSensitiveCrewData })}</td>
                    </tr>
                  );
                })}
              </tbody>
