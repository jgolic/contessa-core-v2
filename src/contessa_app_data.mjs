...
export function themeClasses(darkMode) {
  return {
    page: "bg-vessel-page",
    card: darkMode
      ? "app-dark-panel border border-cyan-300/10 bg-[#0b1828]/92 text-slate-50 shadow-[0_24px_70px_rgba(0,0,0,0.45)] backdrop-blur-xl"
    ...
    unselectedTask: darkMode ? "app-dark-card border-white/10 bg-[#0f2033]/90 text-slate-50 shadow-[0_18px_50px_rgba(0,0,0,0.35)]" : "border-slate-200/80 bg-white/90 text-slate-900 shadow-[0_18px_50px_rgba(15,23,42,0.06)]",
    ring: "ring-vessel",
