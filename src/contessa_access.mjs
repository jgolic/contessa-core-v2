export const APP_MODULES = [
  { key: "today", label: "Command Center" },
  { key: "dashboard", label: "Command Center Analytics" },
  { key: "route", label: "Route Planning" },
  { key: "tasks", label: "Tasks & Maintenance" },
  { key: "expenses", label: "Expenses & Approvals" },
  { key: "maintenance", label: "Tasks & Maintenance" },
  { key: "crew", label: "Certificates & Crew" },
  { key: "certificates", label: "Certificates & Crew" },
