...
import { canExposeSensitiveCrewData } from "../../lib/runtime_config.mjs";
...
function ConfirmableCrewProfileFields({
  ...
  const previewItems = [
    ...
    { label: "Passport No.", value: getCrewIdentifierDisplay(profile.passportNumber, "Not set", { exposeSensitiveData: exposeSensitiveCrewData }) },
    { label: "Seaman's Book No.", value: getCrewIdentifierDisplay(profile.seamansBookNumber, "Not set", { exposeSensitiveData: exposeSensitiveCrewData }) },
  ];
        ...
        <CardContent className="p-5 md:p-6">
          {selectedCrewProfile ? (
            <div>
              ...
              <ConfirmableCrewProfileFields profile={selectedCrewProfile} darkMode={darkMode} canEdit={canEdit} exposeSensitiveCrewData={exposeSensitiveCrewData} onConfirm={onUpdateCrewProfile} />
