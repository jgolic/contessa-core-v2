...
test("objectives filter tabs expose the expected labels, counts, and active state", () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      { value: "pending", label: "Pending", count: 4, active: false },
      { value: "ongoing", label: "In Progress", count: 3, active: true },
      { value: "completed", label: "Completed", count: 2, active: false },
      { value: "approved", label: "Approved", count: 0, active: false },
    ]
  );
});
